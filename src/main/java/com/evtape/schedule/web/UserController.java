...
public class UserController {
	...
	@ApiImplicitParams({
			...
			@ApiImplicitParam(name = "stationId", value = "站点id", required = false, paramType = "body", dataType = "integer"),
			@ApiImplicitParam(name = "stationName", value = "站点名", required = false, paramType = "body", dataType = "string"),
			...
			@ApiImplicitParam(name = "employeeCode", value = "人员编码", required = true, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "roleId", value = "角色Id", required = true, paramType = "body", dataType = "integer"),
			@ApiImplicitParam(name = "eduBackGround", value = "学历，高中以下，本科，专科，研究生，博士", required = true, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "partyMember", value = "群众，党员，团员，民主党派", required = true, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "joinDate", value = "入党入团时间", required = false, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "homeAddress", value = "家庭住址", required = true, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "certNo", value = "站务员证书编号", required = false, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "certLevel", value = "站务员证书等级，站务初级", required = false, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "xfzNo", value = "消防证书编号", required = false, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "zwyNo", value = "综控员证书编号", required = false, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "zwyLevel", value = "综控员证书级别", required = false, paramType = "body", dataType = "string"),
			@ApiImplicitParam(name = "backup", value = "是否是补位人员 1是0不是，默认0", required = true, paramType = "body", dataType = "integer"), })
	@ResponseBody
	@PostMapping
	public ResponseBundle addUser(@RequestBody @Validated User user, BindingResult bindingResult) {
	    ...
	    user = Repositories.userRepository.saveAndFlush(user);
